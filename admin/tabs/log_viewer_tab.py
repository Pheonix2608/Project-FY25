...
class LogViewerTab(QWidget):
    ...
    def get_log_files(self):
        """Returns a list of log files in the log directory."""
    ...
    def refresh_log_files(self):
        """Refreshes the list of log files in the dropdown."""
        self.log_files = self.get_log_files()
        self.log_file_dropdown.clear()
        self.log_file_dropdown.addItems(self.log_files)

    def on_log_file_selected(self, filename):
        """Loads the selected log file."""
        if filename:
    ...
    def on_log_file_changed(self, path):
        """Handles the event when a log file is changed by reading only new content."""
        try:
    ...
    def append_log_content(self, new_content):
        """Appends new content to the log display."""
