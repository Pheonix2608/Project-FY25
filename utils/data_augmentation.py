...
def synonym_replacement(sentence, n=1):
    """
    Perform synonym replacement on a sentence.

    :param sentence: The input sentence string.
    :param n: The number of words to replace.
    :return: A new sentence with synonyms replaced.
    """
...
def augment_data(data, augmentation_factor=1, keep_originals=True):
    """
    Augment the intent data using synonym replacement.

    :param data: The original intent data.
    :param augmentation_factor: How many augmented versions to create for each pattern.
    :param keep_originals: Whether to include original patterns in the augmented data.
    :return: Augmented intent data.
    """
